...
PRODUCT_NAME := pa_nicki
PRODUCT_BRAND := Sony
PRODUCT_MODEL := Xperia M
PRODUCT_MANUFACTURER := Sony
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=NICKI BUILD_FINGERPRINT="Sony/C1904_1274-3899/C1904:4.1.2/15.1.C.1.17/3bt96g:user/release-keys" \
